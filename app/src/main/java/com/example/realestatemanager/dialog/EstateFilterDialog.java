package com.example.realestatemanager.dialog;
...
import com.example.realestatemanager.databinding.DialogEstateBinding;
import com.example.realestatemanager.filter.EstateFilter;
import com.example.realestatemanager.filter.FilterData;
...
public class EstateFilterDialog extends DialogFragment {
    ...
    DialogEstateBinding binding;

    final FilterData filterData = new FilterData();
    final EstateFilter propertyFilter = new EstateFilter();

    public EstateFilterDialog(
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        binding = DialogEstateBinding.inflate(getLayoutInflater());
