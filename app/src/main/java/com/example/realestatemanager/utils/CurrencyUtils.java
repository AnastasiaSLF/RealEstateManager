...
public class CurrencyUtils {
    ...
    public static double calculateMonthlyRepayment(double loanAmount, double totalMonthlyRate, int duration) {
    ...
    public static double annualRateToMonthlyRate(double annuallyRate) {
        return Math.pow(1 + annuallyRate, (double) 1 / MOTH_OF_YEAR) - 1;
    }
}
